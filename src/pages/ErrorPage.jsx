...
export default function ErrorPage() {
  return (
    <>
      <div>
        <HeaderApp></HeaderApp>
        <section className="flex flex-col justify-center container m-auto h-screen self-center gap-5">
          ...
          <div className="flex justify-center my-20">
            <Link
              to={"/"}
              className="font-oswald font-bold text-2xl md:text-4xl dark:text-secondary flex animate-pulse "
            >
