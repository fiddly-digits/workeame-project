...
export default function BecomeWorker() {
  ...
  return (
    <div className='flex flex-col items-center w-full my-10'>
      <h3 className='text-2xl font-oswald'>
        Convertete en <span className='font-bold'>Worker</span> para obtener
        todas las ventajas
      </h3>
      <ul>
        <li>Crea tu propio Micrositio</li>
        <li>Oferta tus Servicios</li>
        <li>Deja saber a tus clientes tu disponibildad</li>
        <li>Gestiona tus citas de manera sencilla</li>
      </ul>
      <form
