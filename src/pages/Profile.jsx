...
export default function Profile() {
  ...
  const workeaClasses = clsx(
    'leading-none font-oswald text-[12rem]  md:text-[14rem] lg:text-[18rem] font-bold',
    {
  ...
  return (
    <>
      <div className={backgroundClasses}>
        ...
        <div className='absolute -rotate-90 -left-[3.4rem] top-[20rem] md:-left-[15rem] md:top-[20rem]  lg:right-[45rem] lg:top-[19rem] '>
