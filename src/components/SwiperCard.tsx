...
export default function SwiperCard({ left }: Props) {
  return (
    <div className="flex flex-col items-center lg:h-96 overflow-hidden bg-white rounded-md shadow-md font-oswald lg:flex-row">
      <div
        className={clsx(
      ...
      >
        <div className="flex flex-col items-center justify-center w-96 lg:w-[35rem]">
